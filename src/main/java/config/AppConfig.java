...
public class AppConfig {
	...
	public static final String Real_DEVICE_NAME = "Android";
	public static final String Real_PLATFORM_NAME = "Android";
	public static final String Real_APP_PACKAGE = "com.qdtas.homelyf_services";
